...
//        Recipe("Generating Recipe...", "Generating Recipe...", -1, "", "", searchId = 0)
    ...
    fun singleRecipe(): Recipe {
        var ingredientList: List<Ingredient> = listOf(
            Ingredient("Garlic", 1, IngredientType.VEGETABLE),
            Ingredient("Kosher Salt", 1, IngredientType.SPICE),
            Ingredient("Paprika", 1, IngredientType.SPICE),
            Ingredient("Ground Black Pepper", 1, IngredientType.SPICE),
            Ingredient("Cream", 1, IngredientType.DAIRY)
        )
        ...
        var ingredientString =
            "1 tsp sugar,1 lb chicken,a head of lettuce,pinch of pepper,pinch of salt,a bottle of hot sauce"
    ...
    fun recipeIngredientList() =
        listOf("Garlic", "Kosher Salt", "Paprika", "Ground Black Pepper", "Cream")
